...
var _materialUiStylesMuiThemeProvider2 = _interopRequireDefault(
	_materialUiStylesMuiThemeProvider
);
...
var MaterialUiIconPicker = (function (_React$Component) {
	...
	function MaterialUiIconPicker(props) {
		...
		_get(
			Object.getPrototypeOf(MaterialUiIconPicker.prototype),
			"constructor",
			this
		).call(this, props);
				...
				var icons = this.state.icons.map(function (icon, index) {
					return _react2["default"].createElement(
						...
						_react2["default"].createElement("div", {
							style:
								_this2.state.selected &&
								_this2.state.selected.name === icon.name
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							_react2["default"].createElement(
								_materialUi.FontIcon,
								{ className: "material-icons" },
								(_this2.state.selected && _this2.state.selected.name) ||
...
MaterialUiIconPicker.propTypes = {
	...
	labelIcon: _propTypes2["default"].string,
};
